# Seasonal Malaria Chemoprevention (SMC) Installation Guide { #mal-smc-installation }

This document includes an installation guide for the Seasonal Malaria Chemoprevention package.
...
- Seasonal Malaria Chemoprevention (dashboard)
...
- Malaria SMC - Access (view metadata/view data)
- Malaria SMC - Admin (view and edit metadata/no access to data)
- Malaria SMC - Data Capture - (view metadata/capture and view data)
